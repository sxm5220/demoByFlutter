...
class DnsysCircleProgressBarWidget extends StatefulWidget {
  const DnsysCircleProgressBarWidget({
    super.key,
  ...
  @override
  State<DnsysCircleProgressBarWidget> createState() =>
      _DnsysCircleProgressBarWidgetState();
}

class _DnsysCircleProgressBarWidgetState
    extends State<DnsysCircleProgressBarWidget>
  ...
  @override
  void didUpdateWidget(DnsysCircleProgressBarWidget oldWidget) {
    ...
    return AspectRatio(
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          return CustomPaint(
            foregroundPainter: DnsysCircleProgressBarPainter(
...
class DnsysCircleProgressBarPainter extends CustomPainter {
  final double percentage;
  final double strokeWidth;
  final Color? backgroundColor;
  final Color foregroundColor;

  DnsysCircleProgressBarPainter({
  ...
  bool shouldRepaint(CustomPainter oldDelegate) {
    final oldPainter = (oldDelegate as DnsysCircleProgressBarPainter);
