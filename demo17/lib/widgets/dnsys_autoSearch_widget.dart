...
class DnsysAutoSearchWidget extends StatefulWidget {
  ...
  @override
  State<DnsysAutoSearchWidget> createState() => _DnsysAutoSearchWidgetState();
}

class _DnsysAutoSearchWidgetState extends State<DnsysAutoSearchWidget> {
  List<String> results = [];
                ...
                if (_textEditingController.text.isNotEmpty)
                  TextSpan(
                    ...
                    style: TextStyle(
                      ...
                      color: widget.selectedTextColor ?? Colors.green,
                    ),
                  ),
                TextSpan(
