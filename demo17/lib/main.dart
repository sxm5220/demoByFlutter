...
import 'package:t/dnsys_main_page.dart';
import 'package:t/main6_page.dart';
import 'package:t/widgets/dnsys_introScreenOnBoarding_widget.dart';
...
class DnsysMain4Page extends StatefulWidget {
  const DnsysMain4Page({super.key});

  @override
  State<DnsysMain4Page> createState() => _DnsysMain4PageState();
}

class _DnsysMain4PageState extends State<DnsysMain4Page>
...
class _DnsysMain5PageState extends State<DnsysMain5Page> {
  ...
  void toggleCamera() async {
    ...
    setState(() {});
    print('isCameraOpen:$isCameraOpen');
  }
}
...
class MyApp extends StatelessWidget {
  ...
  static Brightness get brightness => MediaQueryData.fromView(
      ...
      .platformBrightness;
  static bool get currentIsDark => brightness == Brightness.dark;

  // This widget is the root of your application.
  @override
  Widget build(BuildContext context) {
    return ScreenUtilInit(
        designSize: const Size(750, 1334), //ipad Size(1536, 2048)
        ...
        builder: (context, child) {
          return MaterialApp(
              ...
              colorScheme: ColorScheme.fromSeed(
                ...
                background: currentIsDark
                    ? Colors.black
                    : const Color.fromRGBO(245, 245, 245, 1),
              ),
              appBarTheme: AppBarTheme(
                surfaceTintColor: currentIsDark ? Colors.black : Colors.white,
              ...
              bottomNavigationBarTheme: BottomNavigationBarThemeData(
                selectedIconTheme: const IconThemeData(
                    size: 20, color: Color.fromRGBO(92, 146, 229, 1)),
              ...
              /*primaryColorDark: const Color.fromRGBO(0, 122, 255, 1),
              primaryColor: const Color.fromRGBO(
                  1, 145, 220, 1), //Color.fromRGBO(39, 147, 255, 1),
              primaryColorLight: const Color.fromRGBO(90, 170, 255, 1),
...
class _MyHomePageState extends State<MyHomePage> {
  final List<DnsysIntroductionWidget> list = [
  ...
  @override
  Widget build(BuildContext context) {
    return DnsysIntroScreenOnBoardingWidget(
      ...
      onTapSkipButton: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const DnsysMainPage(),
          ), //MaterialPageRoute
        );
      },
