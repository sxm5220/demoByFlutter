...
List<ContactVO> contactData = [
  ...
  ContactVO(seationKey: 'J', name: '姬如雪', avatarUrl: ''),
  ...
  ContactVO(seationKey: 'L', name: '留学生', avatarUrl: ''),
  ContactVO(seationKey: 'L', name: '李先森', avatarUrl: ''),
  ContactVO(seationKey: 'L', name: '罗森', avatarUrl: ''),
  ContactVO(seationKey: 'L', name: '老司机', avatarUrl: ''),
  ...
  ContactVO(seationKey: 'Q', name: '乔大', avatarUrl: ''),
  ContactVO(seationKey: 'Q', name: '乔小', avatarUrl: ''),
  ContactVO(seationKey: 'Q', name: '邱小玲', avatarUrl: ''),
  ContactVO(seationKey: 'Q', name: '齐东宇', avatarUrl: ''),
  ContactVO(seationKey: 'R', name: 'rogerMan', avatarUrl: ''),
  ContactVO(seationKey: 'S', name: '石头熊', avatarUrl: ''),
  ContactVO(seationKey: 'S', name: '孙丽', avatarUrl: ''),
  ContactVO(seationKey: 'S', name: '沈家', avatarUrl: ''),
  ContactVO(seationKey: 'T', name: '天天', avatarUrl: ''),
  ContactVO(seationKey: 'W', name: '薇薇安', avatarUrl: ''),
  ContactVO(seationKey: 'X', name: '小猪', avatarUrl: ''),
  ContactVO(seationKey: 'X', name: '小猪佩奇', avatarUrl: ''),
  ContactVO(seationKey: 'X', name: '茜茜', avatarUrl: ''),
  ContactVO(seationKey: 'Y', name: '杨洋', avatarUrl: ''),
  ContactVO(seationKey: 'Z', name: '张一山', avatarUrl: ''),
];
